...
![Bowl Rendered](bowl-rendered.png)
...
![Low Poly Blender](low-poly-blender.png)
...
![overlapping models](overlapping-models.png)
...
![Linked Duplicate](linked-duplicate.png)
...
![Outliner Names](outliner-names.png)
...
![Selected To Active](selected-to-active.png)
...
![Select Normal Node](select-normal-node.png)
...
![Hit Bake](hit-bake.png)

We can finally hit bake!

![Messed Up Bake.Pnmg](messed-up-bake.png)
...
![Messed Up Bake Normals](messed-up-bake-normals.png)

As you can see looking at our "Low Poly" object something is very off.

![Extrusion And Max Ray Distance](extrusion-and-max-ray-distance.png)
...
![Select Roughness](select-roughness.png)
...
![Bake Type Rough](bake-type-rough.png)

Select "Roughness" for Bake Type and hit Bake again.

![Roughness Result](roughness-result.png)

After waiting for the bake to complete we now have a roughness map and the shininess of our bowl now looks correct. Last but certainly not least we need to bake albedo, this is the actual surface color of our object.

# Baking an Albedo Map

![Select Albedo](select-albedo.png)

Just as before we need to select the Albedo texture node in the shader node editor. 

![Bake Type Diffuse](bake-type-diffuse.png)

We set the Bake Type to "Diffuse" this time, but there is one more thing before you bake!

![Bake Influence](bake-influence.png)
...
![Emission Colour](emission-colour.png)
